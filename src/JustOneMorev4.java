	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < wordListLength; i++) {
			...
			for(int j=0; j<newWordList.size(); j++) {
				newWord=newWord+(String)newWordList.get(j);
			} // for j

			newElementList.add(newWord);
		...
		System.out.println(displayList(newElementList));
